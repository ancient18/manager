...
const prop = ['birthday', 'sex', 'identity_card', 'marriage', 'education', 'address1', 'address2', 'phone',
    'mobile_phone', 'company', 'trade', 'position', 'address3', 'company_type', 'company_email',
    'company_phone', 'income', 'contact', 'contact_name', 'contact_phone', 'contact2',
    'contact2_name', 'contact2_phone', 'contact2_dep', 'contact2_pos', 'remark'];

const label = ['出生日期', '性别', '身份证', '婚姻状况', '学历', '居住地址', '工作地址', '手机', '手机', '公司', '行业', '职位',
    '公司地址', '公司类型', '公司邮箱', '公司电话', '收入', '联系人', '联系人姓名', '联系人手机', '联系人2', '联系人2姓名',
    '联系人2手机', '联系人2部门', '联系人2职位', '备注'];

let form = prop.reduce((pre, cur) => {
    pre[cur] = '';
    return pre;
}, {});
...
export default {
    ...
    // filters: {
    //     formatDate(value) {
    //         const translations = prop.reduce((pre, cur, index) => {
    //             pre[cur] = label[index];
    //             return pre;
    //         }, {})
    //     },
